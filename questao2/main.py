...
# Path to the Otsu-segmented strawberry image (generated by questao1)
...
def process_strawberry_chain_code():
    ...
    # Save results
    cv2.imwrite("./questao2/strawberry_chain_code_boundary.png", combined)
    
    # Save chain code to file
    with open("./questao2/strawberry_chain_code.txt", "w") as f:
